...
#ifndef __AutomationProxyStubHeaders_h__
#define __AutomationProxyStubHeaders_h__
...
EXTERN_C const IID IID_IMyMath;
    ...
    MIDL_INTERFACE("08BE5A89-D22B-4B2C-A02A-DB801147A596")
...
#ifndef __AutomationDllServerTypeLib_LIBRARY_DEFINED__
#define __AutomationDllServerTypeLib_LIBRARY_DEFINED__

/* library AutomationDllServerTypeLib */
/* [helpstring][version][uuid] */ 


EXTERN_C const IID LIBID_AutomationDllServerTypeLib;

EXTERN_C const CLSID CLSID_CMyMath;

#ifdef __cplusplus

class DECLSPEC_UUID("DABB2740-C7DB-43FF-A321-03039B49C189")
CMyMath;
#endif
#endif /* __AutomationDllServerTypeLib_LIBRARY_DEFINED__ */
